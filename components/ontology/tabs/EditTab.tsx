        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="h-8 px-3 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-400"
            />
          ...
          <div className="mb-4 p-4 border border-gray-200 rounded-lg bg-gray-50 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <input type="text" placeholder="obj_id (선택, 자동생성 가능)" value={addNodeForm.obj_id}
                ...
                className="h-9 px-3 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-400" />
                    ...
                    <>
                      ...
                      <td className="px-3 py-2">
                        <input value={editingNode.label} onChange={e => setEditingNode(n => n ? { ...n, label: e.target.value } : n)}
                          className="w-full h-7 px-2 text-sm border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-gray-400" />
                      </td>
                      <td className="px-3 py-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input type="text" placeholder="예: sigun:48121" value={addEdgeForm.src}
                  ...
                  className="w-full h-9 px-3 text-sm border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-400" />
              </div>
              <div>
