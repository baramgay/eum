...
const typeBadge: Record<ColType, string> = {
  scale: 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300',
  nominal: 'bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300',
  ordinal: 'bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-300',
}
    ...
    <div className="space-y-4">
      ...
      {!session && (
        <Card padding="lg" className="max-w-2xl mx-auto">
          ...
          {loadError && (
            <div className="mt-4 flex items-start gap-2 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg text-sm text-red-700 dark:text-red-300 max-w-lg mx-auto">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                >
                  ...
                  {localHistory.length > 0 && (
                    <span className="ml-1 px-1.5 py-0.5 text-[10px] bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 rounded-full">{localHistory.length}</span>
                  )}
                ...
                <Card padding="md">
                  ...
                  {!validation.ok && validation.messages.length > 0 && (
                    <div className="mt-4 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                      <p className="text-xs font-semibold text-red-700 dark:text-red-300 mb-1">분석을 실행하기 위해 필요한 항목</p>
                ...
                {result && (
                  <Card padding="md" className="min-h-[200px]">
                    {result.ok ? (
                      ...
                      <div className="flex items-start gap-3 text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-900/20 rounded-lg p-4">
